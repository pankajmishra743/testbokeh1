...
from bokeh.models import Slider, HoverTool, Select, CustomJS, ColumnDataSource, CDSView
...
def update_plot(attr, old, new):
    ...
    p = make_plot(input_field, str(yr), geosource)
...
def make_plot(field_name, current_Year, geosource):  
...
def make_doc():
    ...
    p = make_plot(input_field, "2017", geosource)
